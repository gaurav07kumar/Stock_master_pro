...
while trade_count < 2 :
    ...
    dd =(kite.historical_data(nifty,from_date.strftime('%Y-%m-%d'), to_date.strftime('%Y-%m-%d'), '10minute'))
...
transaction_df.to_csv('real_bearBull_both_transaction_data.csv', index=False)
